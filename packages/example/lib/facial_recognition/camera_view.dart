...
class _CameraViewState extends State<CameraView> {
  ...
  Widget _liveFeedBody() {
    ...
    return Stack(
      ...
      children: [
        Center(
          child: _changingCameraLens
              ...
              : SizedBox(
                  ...
                  child: CameraPreview(
                    _controller!,
                    child: FacialRecognitionProvider().getShowCoordinates
                        ? widget.customPaint
                        : SizedBox(),
                  ),
                ),
        ...
        Visibility(
          visible: widget.showToggleCamera,
          child: _switchLiveCameraToggle(),
        ),
        Visibility(
          visible: widget.showToggleViewMode,
          child: _detectionViewModeToggle(),
        ),
        Visibility(
          visible: widget.showZoomControl,
          child: _zoomControl(),
        ),
        Visibility(
          visible: widget.showExposureControl,
  ...
  Future _startLiveFeed() async {
    ...
    _controller?.initialize().then((_) {
      ...
      _controller?.setZoomLevel(widget.initialZoomLevel);
